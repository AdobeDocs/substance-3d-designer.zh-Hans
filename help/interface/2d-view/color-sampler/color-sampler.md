...
![颜色取样器工具](color-sampler.resources/color-sampler-01.png "颜色取样器工具"){zoomable="yes"}
...
1. 单击2D视图工具栏中的![](color-sampler.resources/color-sampler-02.png) <b>“信息”</b>按钮，以打开“信息”停放区和工具栏
1. 单击“信息”工具栏中的![](color-sampler.resources/color-sampler-03.png) <b>彩色Sampler工具</b>按钮
1. 在视口中，单击要采样的特定像素以放置![](color-sampler.resources/color-sampler-04.png) <b>针脚</b>
1. 检查信息坞的专用部分中的取样值
1. 使用完工具后，单击![](color-sampler.resources/color-sampler-05.png) <b>“删除”</b>按钮以从视区中删除图钉。\
   还可以通过单击图钉上的RMB并在上下文菜单中选择“删除”操作来删除图钉。

下面演示了该工具的实际运行：

![颜色取样器：使用工具](color-sampler.resources/color-sampler-06.gif "颜色取样器：使用工具"){zoomable="yes"}
...
![颜色取样器：复制RGBA值](color-sampler.resources/color-sampler-07.gif "颜色取样器：复制RGBA值"){zoomable="yes"}
...
![采样信息](color-sampler.resources/color-sampler-08.png "采样信息"){zoomable="yes"}
