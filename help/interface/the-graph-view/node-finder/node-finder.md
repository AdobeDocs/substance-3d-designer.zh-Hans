...
breadcrumb-title: ''
description: 使用Node Finder在Substance图中快速搜索和查找节点，以便有效地导航。
...
![节点查找器工具栏](../../../assets/node-finder-toolbar.png "节点查找器工具栏"){zoomable="yes"}
...
* 实例节点引用的图形</b>的<b>标识符
* 节点参数函数中使用的公开参数或变量的<b>标识符</b>
* 节点的<b>UID</b>（唯一标识符）
* 节点的<b>标签</b>

搜索可以递归遍历[图形实例](../../../compositing-graphs/creating-compositing-gra/graph-instances-sub-gra/graph-instances-sub-graphs.md)，以便可以跨[子图](../../../compositing-graphs/creating-compositing-gra/graph-instances-sub-gra/graph-instances-sub-graphs.md)找到节点和变量。 如果不确定需要搜索的确切术语，可使用模糊搜索选项将公差应用于查询。

## 界面

您可以通过两种方式访问Node Finder ：

在图形视图中，按<b>Ctrl+F</b> (Windows) / <b>Cmd+F</b> (macOS)可显示Node Finder工具栏并自动将焦点设置为查询字段。 这使您可以快速执行搜索。

在“图形视图”工具栏中，单击<b>节点查找器按钮![](../../../assets/graph-node-finder.png)</b>以显示节点查找器工具栏。 显示后，仅通过单击此按钮关闭工具栏。

<b>搜索遍历图形</b>。 换言之，通过下列操作打开图表时，搜索将保持活动状态：

* 实例节点：在上下文中打开引用(Ctrl+E / Cmd+E) （*注意：*&#x200B;需要在编辑>首选项>图形中启用在上下文中编辑图形）
* 像素处理器：编辑功能(Ctrl+E / Cmd+E)
* 值处理器：编辑功能(Ctrl+E / Cmd+E)
* FX-Map：编辑FX-Map图形(Ctrl+E / Cmd+E)
* 节点参数：编辑函数

![节点查找器：搜索期间遍历图形](../../../assets/node-finder-traversal.gif "节点查找器：搜索期间遍历图形"){zoomable="yes"}

### 搜索查询

![节点查找器查询字段](../../../assets/node-finder-query-field.png "节点查找器查询字段"){zoomable="yes"}
...
![节点类型](../../../assets/node-finder-node-types.png "节点类型"){zoomable="yes"}
...
![节点类型（函数）](../../../assets/node-finder-types-function.png "节点类型（函数）"){zoomable="yes"}
...
+++搜索原子节点
![节点查找器：按“级别”类型搜索（合成）](../../../assets/node-finder-compositing-levels.png "节点查找器：按“级别”类型搜索（合成）"){zoomable="yes"}
...
使用<b>搜索选项按钮![](../../../assets/node-finder-search-options.png)</b>可打开用于搜索的可打开和关闭设置的列表。
...
![节点查找器搜索选项](../../../assets/node-finder-search-options-open.png "节点查找器搜索选项"){zoomable="yes"}
...
![节点查找器：节点变量](../../../assets/node-finder-compositing-variable.png "节点查找器：节点变量"){zoomable="yes"}
...
![节点查找器查询建议](../../../assets/node-finder-available-query-suggestions.png "节点查找器查询建议"){zoomable="yes"}
...
![节点查找器：从控制台警告/错误搜索变量](../../../assets/node-finder-console-identifier.png "节点查找器：从控制台警告/错误搜索变量"){zoomable="yes"}
...
![节点查找器：按UID搜索](../../../assets/node-finder-compositing-uid-search.png "节点查找器：按UID搜索"){zoomable="yes"}
...
![节点查找器：复制节点UID操作](../../../assets/node-finder-compositing-uid-copy.png "节点查找器：复制节点UID操作"){zoomable="yes"}
...
![节点查找器：从控制台搜索节点UID](../../../assets/node-finder-console-uid.png "节点查找器：从控制台搜索节点UID"){zoomable="yes"}
...
使用<b>搜索选项按钮![](../../../assets/node-finder-search-options.png)</b>可以切换用于搜索节点的<b>递归</b>和<b>模糊</b>模式。
...
+++示例2
![节点查找器：递归搜索示例2](../../../assets/node-finder-recursion-02.gif "节点查找器：递归搜索示例2"){zoomable="yes"}
...
![节点查找器：模糊模式](../../../assets/node-finder-functions-fuzzy.png "节点查找器：模糊模式"){zoomable="yes"}
