...
![注释图标](../../../../assets/graphatomic-comment_1.png "注释图标")
...
+++库
在库中，选择<b>图形项</b>类别，然后将“注释”项拖放到图形视图中。
...
![注释：父注释](../../../../assets/graph-comment_parented.gif "注释：父注释")
...
可以使用HTML标记设置文本的格式。 在注释的<b>Description</b>属性中，使用![](../../../../assets/graph-frames_html-markup-button.png) <b>HTML标记</b>按钮切换此格式。

>[!TIP]
>
> 请在[帧](../../../../interface/the-graph-view/graph-items/frame/frame.md)文档的<b>描述</b>部分中了解有关此功能的更多信息。

![注释：HTML标记](../../../../assets/graph-comment_html-markup.gif "注释：HTML标记")
