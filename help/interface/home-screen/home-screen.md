...
![返回按钮](../../assets/home-screen-back-icon.jpg "返回按钮")

</td>
</tr>
</table>

![主页部分](../../assets/home-screen-home_1.jpg "主页部分"){width="512px"}

## 主屏幕

![](../../assets/home-screen-home-icon.jpg) <b>主页</b>部分提供了一个横幅，其中突出显示了进一步使用Designer的建议。\
可使用右侧的![](../../assets/home-screen-expand-icon.jpg) <b>“隐藏建议”</b>按钮折叠此横幅。
...
![学习分区](../../assets/home-screen-learn.jpg "学习分区"){width="512px"}

## 学习

![](../../assets/home-screen-learn-icon.jpg) <b>学习</b>部分提供了有用的学习资源，可增进您对Substance 3D Designer的了解。
...
* <b>更多资源</b>收集您可能会发现有用的资源，以便定期返回：
  ...
  * [Quicktips](https://substance3d.adobe.com/tutorials/courses/Designer-Quicktips/youtube-Q9mEcCWsOQc)是一组精选的技术播放列表，用于创建素材、图案、滤镜等；
  * [联机文档](../../home/home.md)将您带到此文档。

![新增功能屏幕](../../assets/home-screen-whats-new.jpg "新增功能屏幕"){width="512px"}

## 新增功能

屏幕右上角的![](../../assets/home-screen-whats-new-icon.jpg) <b>“新增功能”</b>按钮会显示一个屏幕，其中列出了Designer版本中添加的主要功能，以及指向该版本的完整[发行说明](../../release-notes/release-notes.md)的链接。

## 启动项目

在屏幕的左侧，您可以找到用于在新包中创建新图形的快捷键列表：

* <b>新Substance图形：</b>打开[新Substance图形](../../compositing-graphs/creating-compositing-gra/creating-a-substance-compositing-graph.md)窗口；
* <b>打开包：</b>允许您加载现有包；
* <b>导入AxF：</b>启动[AxF导入工作流](../../resources/axf-appearance-exchange/axf-appearance-exchange-format.md)。

![关于Substance 3D Designer屏幕](../../assets/home-screen-about.jpg "关于Substance 3D Designer屏幕"){width="256px"}
