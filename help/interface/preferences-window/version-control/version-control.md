---
helpx_url: "https://helpx.adobe.com/cn/substance-3d-designer/interface/preferences-window/version-control.html"
breadcrumb-title: ''
...
![P4V工作区信息](version-control.resources/version-control-01.jpg "P4V工作区信息"){zoomable="yes"}
...
项目设置中的![“版本控制”选项卡](version-control.resources/version-control-02.jpg "项目设置中的“版本控制”选项卡"){zoomable="yes"}
...
![Designer中的P4设置：工作区](version-control.resources/version-control-03.jpg "Designer中的P4设置：工作区"){zoomable="yes"}
...
![Designer中的P4设置：操作](version-control.resources/version-control-04.jpg "Designer中的P4设置：操作"){zoomable="yes"}
...
![Designer中的P4设置：解释器](version-control.resources/version-control-05.jpg "Designer中的P4设置：解释器"){zoomable="yes"}
...
1. 根据工作区中包文件的状态，有几种操作可用：
   ...
   * <b>刷新状态：</b>刷新包文件状态
   ...
   ![“提交”对话框](version-control.resources/version-control-06.jpg "“提交”对话框"){zoomable="yes"}

   </td>
   <td style="border: 0;" valign="top">

   ![“恢复”对话框](version-control.resources/version-control-07.jpg "“恢复”对话框"){zoomable="yes"}
...
![包图标：最新](version-control.resources/version-control-08.png "包图标：最新")
...
![包图标：已签出](version-control.resources/version-control-09.png "包图标：已签出")
...
![包图标：已添加](version-control.resources/version-control-10.png "包图标：已添加")
...
![包图标：不在仓库中](version-control.resources/version-control-11.png "包图标：不在仓库中")
