...
* [将包Publish到Substance 3D资源(SBSAR)](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/publishing-sbsar-file-200574380.html)
* [将包发送到其他Substance 3D应用程序](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/send-to-215286290.html)
...
<b>Publish .sbsar文件</b>和<b>重新发布.sbsar文件</b>允许您[将未编译且未优化的Substance图形Publish为在其他Substance应用程序和集成中为我们提供高效且便携的SBSAR文件](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/publishing-sbsar-file-200574380.html)。 Publish as Previous使用相同的选项重复以前的Publish操作，跳过选项对话框以加快迭代。 工具栏包含具有相同功能的按钮。
...
<b>发送至……</b>可打开子菜单，允许您直接[将包发送至](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/send-to-215286290.html)到[Substance 3D Sampler](https://www.adobe.com/products/substance3d-sampler.html)、[Substance 3D Painter](https://www.adobe.com/products/substance3d-painter.html)、[Substance 3D Stager](https://www.adobe.com/products/substance3d-stager.html)或[Substance Player](https://helpx.adobe.com/substance-3d-player/home.html)。
...
<b>打开：</b> （返回）在[3D视图](../../interface/3d-view/3d-view.md)中使用此3D网格，替换标准立方体或平面。
...
<b>新建：</b>允许您在文件夹中创建新的图形([Substance图形](../../compositing-graphs/substance-compositing-graphs.md)、[Substance函数图形](../../function-graphs/function-graphs.md)、[位图](../../resources/bitmap-resource/bitmap-resource.md)和[矢量图形](../../resources/vector-graphics-svg-res/vector-graphics-svg-resource.md)资源，以及用于排序内容的&#x200B;*文件夹*。
...
<b>计算输出：</b>计算文件夹中包含的所有图表的输出并将它们保留在内存中。

+++

## 底部工具栏

Explorer停靠区底部的工具栏提供有关程序包或程序包资源的信息：
