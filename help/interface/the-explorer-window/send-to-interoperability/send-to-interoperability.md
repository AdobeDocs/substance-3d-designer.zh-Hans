...
![从Designer发送到Substance 3D应用程序](send-to-interoperability.resources/explorer-interop.png "从Designer发送到Substance 3D应用程序"){width="512px"}
...
![Substance图形的类型属性](send-to-interoperability.resources/type-attribute.jpg "Substance图形的类型属性")
...
* 单击“资源管理器”面板顶部的![](send-to-interoperability.resources/sendto-icon.jpg)<b>“Publish/发送”</b>按钮，然后为目标应用程序选择<b>“发送至……”</b>选项。

</td>
<td style="border: 0;" valign="top">

![资源管理器中的Publish/发送到菜单](send-to-interoperability.resources/explorer-sendto-displayed.jpg "资源管理器中的Publish/发送到菜单")
