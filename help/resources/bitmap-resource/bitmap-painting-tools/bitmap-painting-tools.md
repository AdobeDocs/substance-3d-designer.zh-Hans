...
![2D 视图中的位图绘画工具](../../../assets/2dview-paintingtools-main_1.png "2D 视图中的位图绘画工具"){width="512px"}
...
![](../../../assets/2dview-paintingtools-icon-brush.png) <b>画笔工具(B)：</b>使用工具选项工具栏中定义的选项，在按下笔提示或<b>LMB</b>按钮时在光标位置应用&#x200B;*原色*&#x200B;颜色
...
![](../../../assets/2dview-paintingtools-clone-alignment.png) <b>启用对齐方式（图章工具选项）：</b>用于定义在新图章开始时，源是应&#x200B;*保持在原位*，还是应&#x200B;*相对于新图章位置重定位*

<b>![](../../../assets/2dview-paintingtools-icon-eraser.png)橡皮擦(E)：</b>使用工具选项工具栏中定义的选项，在按下笔提示或<b>LMB</b>按钮时，用光标位置处的(0， 0， 0， 0)值替换图像的当前颜色。 确保已启用[透明度显示](../../../interface/2d-view/2d-view.md)，以跟踪此Alpha对<b>工具</b>通道的影响。
