...
![2D视图中的位图绘画工具](../../../assets/2dview-paintingtools-main_1.png "2D视图中的位图绘画工具"){width="512px"}
...
![新建位图对话框](../../../assets/2dview-paintingtools-new-bitmap.png "新建位图对话框"){width="512px"}
...
![](../../../assets/2dview-paintingtools-icon-colors-primary.png)![](../../../assets/2dview-paintingtools-icon-colors-secondary.png) <b>颜色选择</b> <b>缩略图：</b>用于定义&#x200B;*主要*&#x200B;和&#x200B;*次要*&#x200B;颜色。 单击其中任一缩览图以显示<b>颜色编辑器</b>窗口并定义颜色。 工具将使用&#x200B;*主要*&#x200B;颜色。 可以随时&#x200B;*交换* (<b>X</b>)

![](../../../assets/2dview-paintingtools-icon-brush.png) <b>画笔工具(B)：</b>使用工具选项工具栏中定义的选项，在按住笔尖或<b>LMB</b>按钮时，在光标位置应用&#x200B;*主要*&#x200B;颜色

![](../../../assets/2dview-paintingtools-icon-clone.png) <b>图章工具(T)：</b>允许您将图像的一部分盖印到另一部分上。 您可以通过按住<b>Alt</b>键并单击<b>LMB</b>来定义应盖印的&#x200B;*源*。 然后，使用“工具选项”工具栏中定义的选项按住笔尖或<b>LMB</b>按钮时，图像的此区域将印在光标位置处的&#x200B;*目标*&#x200B;区域上。 请注意，源将&#x200B;*跟踪*&#x200B;目标的移动，并且&#x200B;*源*&#x200B;区域的大小将&#x200B;*匹配*&#x200B;画笔&#x200B;*的大小*

![](../../../assets/2dview-paintingtools-clone-alignment.png) <b>启用对齐方式（图章工具选项）：</b>用于定义在新图章开始时，源是应&#x200B;*保持在原位*，还是应&#x200B;*相对于新图章位置迁移*

<b>![](../../../assets/2dview-paintingtools-icon-eraser.png)橡皮擦(E)：</b>使用工具选项工具栏中定义的选项，在按住笔尖或<b>LMB</b>按钮时，将图像的当前颜色替换为光标位置的(0， 0， 0， 0)值。 确保已启用[透明度显示](../../../interface/2d-view/2d-view.md)，以跟踪此Alpha对<b>工具</b>通道的影响。
...
可以在画笔编辑器中创建和编辑画笔预设，并在&#x200B;*库*&#x200B;中排列。 将显示在此面板中的画笔预设是所有加载的画笔预设库中的&#x200B;*和*。 可通过访问![](../../../assets/2dview-paintingtools-brushpresets-library.png) <b>画笔库</b>菜单来管理这些库（请参阅画笔编辑器的<b>预设</b>部分）
...
![画笔选区面板](../../../assets/2dview-paintingtools-brushes.png "画笔选区面板")
...
![](../../../assets/2dview-paintingtools-icon-brush-options.png) <b>画笔编辑器</b>提供粒度选项以定义画笔的行为：
...
![画笔编辑器](../../../assets/2dview-paintingtools-brusheditor.png "画笔编辑器")
...
<b>纹理文件： </b>定义应用作画笔纹理的位图的&#x200B;*路径*。 您可以使用输入字段旁边的![](../../../assets/2dview-paintingtools-brusheditor-selecttexture.png)按钮，通过系统文件浏览器选择位图
...
![不透明度和流量控制](../../../assets/2dview-paintingtools-opacityflow.png "不透明度和流量控制")
...
画笔、图章和橡皮擦工具还允许您设置其![](../../../assets/2dview-paintingtools-icon-tiling.png) <b>拼贴模式</b>，这定义了当描边影响图像边界之外的区域时，这些工具能够&#x200B;*环绕*&#x200B;到图像另一侧的能力：
...
![拼贴模式](../../../assets/2dview-paintingtools-tiling.png "拼贴模式")
