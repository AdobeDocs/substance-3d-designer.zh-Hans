...
![2D 视图中的位图绘画工具](bitmap-painting-tools.resources/2dview-paintingtools-main_1.png "2D 视图中的位图绘画工具"){width="512px"}
...
![](bitmap-painting-tools.resources/2dview-paintingtools-icon-brush.png) <b>画笔工具(B)：</b>使用工具选项工具栏中定义的选项，在按下笔提示或<b>LMB</b>按钮时在光标位置应用&#x200B;*原色*&#x200B;颜色
...
![](bitmap-painting-tools.resources/2dview-paintingtools-clone-alignment.png) <b>启用对齐方式（图章工具选项）：</b>用于定义在新图章开始时，源是应&#x200B;*保持在原位*，还是应&#x200B;*相对于新图章位置重定位*

<b>![](bitmap-painting-tools.resources/2dview-paintingtools-icon-eraser.png)橡皮擦(E)：</b>使用工具选项工具栏中定义的选项，在按下笔提示或<b>LMB</b>按钮时，用光标位置处的(0， 0， 0， 0)值替换图像的当前颜色。 确保已启用[透明度显示](../../../interface/2d-view/2d-view.md)，以跟踪此Alpha对<b>工具</b>通道的影响。
...
可以在画笔编辑器中创建和编辑笔刷预设，并在&#x200B;*库*&#x200B;中排列。 将显示在此面板中的笔刷预设是所有加载的笔刷预设库的&#x200B;*和*。 可通过访问![](bitmap-painting-tools.resources/2dview-paintingtools-brushpresets-library.png) <b>画笔库</b>菜单来管理这些库（请参阅画笔编辑器的<b>预设</b>部分）
...
可自定义画笔，然后将其保存为<b>笔刷预设</b>，随后将在![](bitmap-painting-tools.resources/2dview-paintingtools-editor-currentpreset.png) <b>笔刷预设列表</b>和![](bitmap-painting-tools.resources/2dview-paintingtools-brush-thumb.png) <b>画笔选区</b>面板中提供该画笔。

要创建预设，请根据您的喜好设置下面的属性，然后单击![](bitmap-painting-tools.resources/2dview-paintingtools-editor-addpreset.png) <b>“添加笔刷预设”</b>按钮，并在<b>“预设名称”</b>窗口中设置画笔名称。 新预设现在会自动在<b>笔刷预设列表</b>中选择，并且您可以随时使用新的当前设置![](bitmap-painting-tools.resources/2dview-paintingtools-editor-updatepreset.png)更新它</b>或![](bitmap-painting-tools.resources/2dview-paintingtools-editor-deletepreset.png)删除它<b>删除它</b>。<b>
...
画笔、图章和橡皮擦工具还允许您设置其![](bitmap-painting-tools.resources/2dview-paintingtools-icon-tiling.png) <b>拼贴模式</b>，这定义了当描边影响图像边界之外的区域时，这些工具能够&#x200B;*环绕*&#x200B;到图像另一侧的能力：
