...
1. <b>成功加载依赖项</b>
   ...
   然后，通过在[资源管理器](../../interface/the-explorer-window/the-explorer-window.md)面板中单击宿主包上的人民币，并在上下文菜单中选择<b>重新加载</b>选项来重新加载宿主包。

   ![“无效的依赖包”解决方案1](warnings-from-dependencies.resources/warnings-dep-invalid-dependent-pkg.gif "“无效的依赖包”解决方案1")
1. <b>重定位包中的依赖项</b>

   可使用[依赖关系重定位器](../../interface/dependency-manager/dependency-manager.md)管理依赖关系。 单击[资源管理器](../../interface/the-explorer-window/the-explorer-window.md)面板中的主机包上的RMB，然后在上下文菜单中选择<b>依赖关系管理器</b>选项。

   在“依赖管理器”的列表中查找缺失的依赖项，单击该依赖项上的人民币，然后选择<b>重定位...</b>选项。 使用文件浏览器对话框查找依赖关系包，然后单击<b>打开</b>。
...
已多次分配![个UV的磁贴](warnings-from-dependencies.resources/warnings-dep-udim-same.gif "个已多次分配UV的磁贴")
