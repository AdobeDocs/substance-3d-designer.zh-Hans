...
当您要输入特定参数值时，无需使用计算器或再在头中进行计算。 现在，在[属性](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/parameters-ui-129368153.html)和应用程序的其他位置中为参数设置数值时，可以直接输入基本公式，如加法、分法、乘法或减法。
