...
通过节点上下文菜单在[输入颜色](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/input-color/input-color.md)和[输入灰度](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/input-grayscale/input-grayscale.md)之间快速切换。
...
此12.4版本还通过Python API完全支持Substance模型图表。 这意味着您现在具有创建、编辑或评估Substance模型图表所需的所有工具。 有关完整的详细信息，请查看软件帮助菜单中的文档。
