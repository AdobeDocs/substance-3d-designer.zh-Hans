...
![栅格化程序中的阴影和translucency](version-15-0.resources/feature_1b.png)
...
* [面包师]更改中间面板的默认大小
* [Bakers] UDIM工作流的输入纹理
* [Baker]建立2D 视图映射列表顺序匹配Baker呈现列表顺序
* [Baker]使烘焙窗口模式化
* [Baker]管理色调映射参数
* [Baker]删除切线空间插件选区
* [Baker]存储预设时，Baker的存储状态为“已启用”或“已禁用”
* [Baker]选择小组件中默认选择材料
* [Baker]设置法线输出纹理相对于首选项的默认方向
* [Baker]默认情况下，将UV拼贴设置为全部
* [Baker] WordSpaceDirection添加选项FromTexture/FromValue
* [Baker]要正切的世界：将默认输入设置为“从纹理”
* [SBSBaker]创建一个选项以控制后端顺序
* [SBSBaker]改进StringList参数的使用
* [SBSBaker]将“match\_source\_instance”重命名为“match\_网格\_name”
* [SBSBaker]将“Submesh”重命名为“GeomSubset”
* [SBSBaker]重命名为substance3d\_Baker
* [内容]将“半球”形状添加到公开象限形状的生成器节点
* [Interop]支持GLTF文件格式
* [Interop]支持PLY文件格式
* [Interop]支持STL文件格式
* [资源库]统一原子节点的工具提示
