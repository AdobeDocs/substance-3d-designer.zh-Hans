...
**Substance Designer2019.2**&#x200B;提供了新的“点”节点、HDR滤镜和强大的优化功能。
...
“点”节点是一个等待已久的请求。 它用于重定向节点之间的连接以重新组织图形。 与之前的重定向点相反，该点可以累积链接，并且不会在连接断开时消失。

若要了解有关点节点的更多信息，请参阅[图形项](../../../interface/the-graph-view/graph-items/graph-items.md)页。
