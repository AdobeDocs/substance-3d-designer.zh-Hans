...
* [Baker]在“来自网格Baker的AO”中添加地面平面选项
* [Baker]添加按名称匹配选项可在“来自网格Baker的AO”中忽略背面
* [Content]新建Atlas Scatter节点
* [内容]新的色彩空间转换节点和功能(ACEScg)
* [内容]改进具有颜色/灰度版本的节点的命名一致性
* [图形]改进预设预览模式下的性能
* [图形]将$(colorspace)宏添加到导出图形输出选项
* [参数]当参数设置为不可见时，在2D 视图中隐藏相应的线框
* [参数]公开参数时，不要将“图形输入组”添加为前缀
...
* [2DView]通过位置调整修改实例图形的输入时崩溃
* [3DView]取消“加载……”时崩溃 操作
* [3DView]在GLSLFX着色器中为发射纹理添加“色彩空间”选项
* [Baker]在烘焙期间忽略通过资源馈送的地图
* [Baker]“世界空间方向”选项被错误地锁定
* [位图]带有浮点值的EXR位图渲染为黑色图像
* [内容]索引Flood Fill：形状检测在特定情况下失败
* [内容]裁剪：当裁剪节点的分辨率比输入的分辨率低时，出现采样问题
* [常规]生成图库时关闭Designer时出现崩溃
* [图形]位图节点不反映关联的位图的压缩
* [图形]在首次渲染后清除节点缩略图时，未清除缓存
* [图形]节点大小错误地无效
* [图形]在某些情况下更改像素处理器节点上的输入连接时im时崩溃
* [MDL 图]恢复函数调用默认值时失败
