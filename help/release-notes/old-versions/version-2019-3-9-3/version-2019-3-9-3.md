...
有关详细信息，请参阅[网格曲率](https://experienceleague.adobe.com/en/docs/substance-3d/bakers/bakers-settings/curvature-from-mesh)文档。
...
有关详细信息，请参阅[Mesh中的环境遮蔽](https://experienceleague.adobe.com/en/docs/substance-3d/bakers/bakers-settings/ambient-occlusion-from-mesh)文档。
