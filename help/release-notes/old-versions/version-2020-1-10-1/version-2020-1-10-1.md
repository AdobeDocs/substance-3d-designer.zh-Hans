...
在SIGGRAPH 2019期间，我们演示了用于Substance Designer的MaterialX增效工具。 [MaterialX](http://www.materialx.org/)是由[工业光和魔法(ILM)](https://www.ilm.com/)开发的格式，使艺术家能够创作材料，然后将其用于各种平台和多种用途（例如电影、电视节目、游戏、VR体验和制造业）。 此新增效工具现已在Beta版中提供，允许创建MaterialX素材，以便在其他兼容的DCC应用程序中使用。 请查看我们最近关于MaterialX](https://magazine.substance3d.com/research-a-portable-shader-graph/)的[文章，以了解有关此新增效工具背后的过程和目标的更多信息。
