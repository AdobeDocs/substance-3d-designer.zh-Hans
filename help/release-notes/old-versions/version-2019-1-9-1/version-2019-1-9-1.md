...
如果要禁用两个后端之一，请前往主要首选项（**编辑>首选项**）和Baker设置：
...
> 
> 请注意，DXR也可在[GeForce GTX 10xx GPU](https://www.nvidia.com/en-us/geforce/news/geforce-gtx-dxr-ray-tracing-available-now/)上使用（包含最新驱动程序）。 DXR还要求Windows为最新版本才能工作，请参阅[此页](../../../best-practices/performance-optimization/performance-optimization-guidelines.md)了解更多信息。

### 缩短了网格的加载时间

![](version-2019-1-9-1.resources/doc-obj-loading.jpg)

在此版本中，我们改进了&#x200B;**obj**&#x200B;文件阅读器以减少3D网格的加载时间。 加载时间已加快到3倍，特别是对于未定义UV和法线的网格。

此性能改进将同时影响Baker和3D 视图。
...
默认库中也提供了一些新节点，其中部分节点现在已使用新的值处理器节点进行供电：
