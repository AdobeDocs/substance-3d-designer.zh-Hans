...
> 
> 请注意，DXR也可用于[GeForce GTX 10xx GPU](https://www.nvidia.com/en-us/geforce/news/geforce-gtx-dxr-ray-tracing-available-now/)（带有最新驱动程序）。 DXR还要求Windows为最新版本才能工作，请参阅[此页](../../../best-practices/performance-optimization/performance-optimization-guidelines.md)了解更多信息。
...
* **高度挤出**\
  生成给定Height的正交3D渲染。 相机视图可通过位置小工具控制。
...
* [Baker]错误消息表明后端失败，而不是错误的原因
* [Baker]在处理没有高模网格的详细映射Baker时崩溃
