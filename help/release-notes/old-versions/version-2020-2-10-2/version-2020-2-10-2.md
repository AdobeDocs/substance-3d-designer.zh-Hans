...
* **改进的烘焙器膨胀和扩散生成**\
  现在，烘焙纹理的膨胀和扩散速度比以前的版本快4倍。 这缩短了两次烘焙之间的等待时间。
...
* **[新阈值滤镜](../../../compositing-graphs/nodes-reference-for-com/node-library/filters/adjustments/threshold/threshold.md)**&#x200B;此节点允许基于灰度输入快速将图像的某些部分隔离为黑白蒙版。 在实践中，这与现有的直方图扫描滤镜类似，但是每天使用起来更方便。 通过[专用文档页面](../../../compositing-graphs/nodes-reference-for-com/node-library/filters/adjustments/threshold/threshold.md)了解更多相关信息。
...
* **改进了[Tile Generator](../../../compositing-graphs/nodes-reference-for-com/node-library/texture-generators/patterns/tile-generator/tile-generator.md)和** [**平铺Sampler**](../../../compositing-graphs/nodes-reference-for-com/node-library/texture-generators/patterns/tile-sampler/tile-sampler.md)\
  ...
  * **保持比例**：保持拼贴的比例，当X轴和Y轴上的计数不均匀时，无需手动补偿大小。
