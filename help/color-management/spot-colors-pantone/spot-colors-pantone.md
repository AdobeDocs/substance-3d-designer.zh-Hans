...
1. 单击RGB色板旁边的![](spot-colors-pantone.resources/spot-colors-pantone-01.png) <b>拾色器类型</b>按钮。
1. 从下拉列表中选择任意<b>色标簿</b>，而不是<b>RGB颜色</b>。
1. ![](spot-colors-pantone.resources/spot-colors-pantone-02.png) <b>拾色器类型</b>的图标将更改，且其界面将更改为<b>专色</b>模式。

![切换到专色模式](spot-colors-pantone.resources/spot-colors-pantone-03.gif "切换到专色模式"){width="512px"}

### 选择和查找专色

有几种方式可以在色标簿中查找和选择专色。

* 您可以使用书籍页面两侧的![](spot-colors-pantone.resources/spot-colors-pantone-04.png) ![](spot-colors-pantone.resources/spot-colors-pantone-05.png) <b>左右箭头</b>在页面之间翻转。 您还可以单击并拖动页面显示，以在页面之间滚动。
...
* 要为色标簿获取更大、更易于使用的界面，请单击![](spot-colors-pantone.resources/spot-colors-pantone-06.png) <b>滴管</b>图标和![](spot-colors-pantone.resources/spot-colors-pantone-04.png) <b>向左箭头</b>之间的颜色预览框。

![浏览专色](spot-colors-pantone.resources/spot-colors-pantone-07.gif "浏览专色"){width="512px"}

### 选取和转换专色

可以使用![](spot-colors-pantone.resources/spot-colors-pantone-06.png) <b>滴管</b>工具选取专色。 在专色模式下，这意味着将取样的RGB转换为当前选定书籍中匹配最接近的专色。
...
![选取和转换专色](spot-colors-pantone.resources/spot-colors-pantone-08.gif "选取和转换专色"){width="512px"}
