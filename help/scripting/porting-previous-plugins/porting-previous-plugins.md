...
相反，插件可以使用<b>新的[UI管理器](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/scripting-api-next-172825023.html)对象</b>和<b>Qt for Python</b>来创建它们需要的任何用户界面元素。
...
增效工具可以使用<b>[UI管理器](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/scripting-api-next-172825023.html)对象</b>访问当前活动的图形和选区。
