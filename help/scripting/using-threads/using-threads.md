---
helpx_url: "https://helpx.adobe.com/cn/substance-3d-designer/scripting/using-threads.html"
breadcrumb-title: ''
...
请务必注意，Designer的Python API中的大多数类和方法只能&#x200B;*从<b>主应用程序线程</b>调用*。 因此，如果要对当前在Designer中打开的任何图形进行任何修改，则必须从主应用程序线程进行修改。
