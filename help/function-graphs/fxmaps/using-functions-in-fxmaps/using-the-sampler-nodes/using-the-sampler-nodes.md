...
breadcrumb-title: ''
description: 了解如何在FXMaps中使用sampler节点对纹理进行采样并创建程序化材质变化。
...
在本示例中，创建了一组象限节点，以生成图案网格。 将在最后一个象限的不透明度/明亮度度参数中创建函数。
...
[![SBS文件图标](using-the-sampler-nodes.resources/sbs-1_1.png){width="64px"}](https://shared-assets.adobe.com/link/d5f9adf3-0bb5-49a1-4eb9-a0506d4f3f32)
