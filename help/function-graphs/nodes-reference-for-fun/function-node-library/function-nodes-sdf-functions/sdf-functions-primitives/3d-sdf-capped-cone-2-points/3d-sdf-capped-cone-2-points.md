---
title: 封闭圆锥2点
description: Designer >Substance合成图表>用于Substance合成图表的SDF 函数参考>节点库>节点>基元>封闭的圆锥2点
...
|  |  |
| :--- | :--- |
| <b>定位基数</b> *浮点3* | 封顶圆锥基底的位置。<br><br><i>默认值： (0， 0， 0)</i> |
| <b>位置靠上</b> *浮点3* | 封闭圆锥顶部的位置。<br><br><i>默认值： (0， 0， 1)</i> |
