...
<img style="display: block; margin: auto;" src="working-with-sdf-functions.resources/working-with-sdf-functions-01.gif" alt="Substance 3D Designer中的3DSDF 函数节点功能的Mograph" />
...
<table style="border: none">
    <tr style="border: 0">
        ...
        <td style="border: 0; width: 33%; vertical-align: top">
            <img src="./working-with-sdf-functions.resources/working-with-sdf-functions-02.gif" alt="由SDF 函数生成的形状的可视化，带有扫过的等值线。" />
        </td>
    </tr>
</table>
...
* 该图形只有一个输出节点。 右键单击某个节点，然后选择`Set as output`以将其指定为输出节点。
* 同样，与图形类似，有&#x200B;*原子*&#x200B;节点（基本构造块）和&#x200B;*实例*&#x200B;节点（表示其他Substance函数图形）。
...
<img style="margin-top: 32px; margin-bottom: 32px;" src="./working-with-sdf-functions.resources/working-with-sdf-functions-04.gif" alt="设置SDF 函数可视化的3D查看器节点。" />

>[!TIP]
> 
> <table style="border: none"><tr style="border: none"><td style="border: none; vertical-align: top"><p>所有SDF 函数节点及其输入连接器都有工具提示，可帮助您进一步了解其用途和使用方法。</p><p>一定要检查他们！</p></td><td style="border: none; width: 33%; vertical-align: top"><img src="./working-with-sdf-functions.resources/working-with-sdf-functions-05.png" alt="SDF 函数节点上输入连接器的工具提示。" /></td></tr></table>
...
<img style="margin-top: 32px; margin-bottom: 32px" src="working-with-sdf-functions.resources/working-with-sdf-functions-06.gif" alt="用于编辑SDF基元的常量节点。" />

>[!TIP]
> 
> <table style="border: none"><tr style="border: none"><td style="border: none; vertical-align: top"><p>如果您不需要始终保持某些值可见，请使用<code>D</code>键停靠节点以节省空间并减少图形。</p><p>您还可以使用注释来跟踪值。</p></td><td style="border: none; width: 67%; vertical-align: top"><img src="./working-with-sdf-functions.resources/working-with-sdf-functions-07.png" alt="SDF 函数节点上输入连接器的工具提示。" /></td></tr></table>
...
<table style="border: none">
    <tr style="border: none">
        ...
        <td style="border: none; width: 33%; vertical-align: top">
            <img src="./working-with-sdf-functions.resources/working-with-sdf-functions-08.jpg" alt="适用于SDF 函数的3D查看器节点的边界帧功能。" />
        </td>
    </tr>
</table>
...
<table style="border: none">
    <tr style="border: none">
        ...
        <td style="border: none; width: 33%; vertical-align: top">
            <img src="./working-with-sdf-functions.resources/working-with-sdf-functions-09.jpg" alt="适用于SDF 函数的3D查看器节点的边界帧功能。" />
        </td>
    </tr>
</table>
...
* 允许您修改和/或复制形状的&#x200B;**其他专门化**&#x200B;运算符，例如[Shell](sdf-functions-operators/3d-sdf-op-shell/3d-sdf-op-shell.md)和[对称](sdf-functions-operators/3d-sdf-op-symmetry/3d-sdf-op-symmetry.md)。
...
![使用 — sdf-材料-id.png](working-with-sdf-functions.resources/working-with-sdf-functions-13.png)\
...
<table style="border: none; margin-top: 32px">
    <tr style="border: 0">
        <td style="border: 0; width: 33%">
            <img src="./working-with-sdf-functions.resources/working-with-sdf-functions-14.jpg" alt="在形状飞片v2映射器颜色节点中用于颜色映射的SDF材料ID。"/><i>用于形状飞溅v2映射器颜色中的颜色映射的材质ID<br></i>
        </td>
        <td style="border: 0; width: 33%">
            <img src="./working-with-sdf-functions.resources/working-with-sdf-functions-15.jpg" alt="在形状飞溅v2映射器颜色节点中用于三平面映射的SDF材料ID。"/><i>用于三平面映射的材质ID<br>在形状飞溅v2映射器颜色中</i>
        </td>
        <td style="border: 0; width: 33%">
            <img src="./working-with-sdf-functions.resources/working-with-sdf-functions-16.jpg" alt="在形状飞溅v2中用于蒙版的SDF素材ID到蒙版节点。"/><br><i>用于遮盖的素材ID<br>在形状飞溅v2中遮盖</i>
        </td>
    </tr>
</table>
...
<table style="border: none; margin-top: 32px">
    <tr style="border: 0">
        <td style="border: 0; width: 33%">
            <img src="./working-with-sdf-functions.resources/working-with-sdf-functions-17.jpg" alt="形状飞溅v2节点的SDF颜色输出。"/><i>SDF颜色输出</i>
        </td>
        <td style="border: 0; width: 33%">
            <img src="./working-with-sdf-functions.resources/working-with-sdf-functions-18.jpg" alt="形状飞溅v2节点的SDF粗糙度。"/><br><i>SDF粗糙度输出</i>
        </td>
        <td style="border: 0; width: 33%">
            <img src="./working-with-sdf-functions.resources/working-with-sdf-functions-19.jpg" alt="形状飞溅v2节点的SDF金属性。"/><i>SDF金属性输出</i>
        </td>
    </tr>
</table>
...
<table style="border: none">
    <tr style="border: none">
        ...
        <td style="border: none; width: 20%; vertical-align: top; text-align: right">
            <img src="./working-with-sdf-functions.resources/working-with-sdf-functions-20.png" alt="适用于SDF 函数的3D查看器节点的边界帧功能。" />
        </td>
    </tr>
</table>
