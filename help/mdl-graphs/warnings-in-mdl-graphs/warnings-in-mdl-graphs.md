...
breadcrumb-title: ''
description: 了解并解决MDL 图中的警告，以确保正确的材料定义和渲染。
...
>[!NOTE]
>
> 此部分中的插图记录在<b>Substance模型图表</b>中，这些图表在Substance 3D Designer版本<b>13.0.0</b>中&#x200B;*已弃用*。 但是，它们也适用于MDL 图。

## ![（错误）](warnings-in-mdl-graphs.resources/error.svg)未定义输出节点

图形未定义输出节点。

<b>！[(tick)](warnings-in-mdl-graphs.resources/check.svg)解决方案</b>
