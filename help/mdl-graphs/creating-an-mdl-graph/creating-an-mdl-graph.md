...
breadcrumb-title: ''
description: 了解如何在Substance 3D Designer中创建材质定义语言图表，用于自定义材质创建。
...
本页介绍了创建MDL图形以在Substance 3D Designer中创作MDL材质的过程。

![MDL图形创建路径](../../assets/mdl-new-graph-hl.png "MDL图形创建路径")

*在Designer界面中创建新MDL图表的路径*

## 创建MDL图形的方法

可以使用以下任一方法创建MDL图形：

* 在&#x200B;*主菜单栏*&#x200B;中选择&#x200B;**文件>新建> MDL图形**&#x200B;选项
* 单击&#x200B;*主工具栏*&#x200B;中的![](../../assets/mdl-new-graph-icon.png) **添加MDL图形**&#x200B;按钮
* 右键单击&#x200B;**资源管理器**&#x200B;面板中的&#x200B;*现有包*，然后选择&#x200B;**新建> MDL图形**&#x200B;选项

您将看到&#x200B;**新建MDL图形**&#x200B;对话框，请参阅下文。

![新建MDL图形对话框](../../assets/mdl-templates.png "新建MDL图形对话框")

*新建MDL图形对话框*

## “新建MDL图形”对话框

无论使用哪种方法创建新MDL图形，您始终会看到<b>新MDL图形</b>对话框，您可以使用该对话框配置新图形。

### 模板

通过<b>模板</b>部分，您可以选择图形模板，其中包括预配置的节点，以便更快地开始使用图形。 预配置的节点包括“输出”节点、用于将值传递到这些输出的简单节点（例如，统一颜色）以及取决于模板的“输入”节点。

要从完全的&#x200B;*空白*&#x200B;图表开始，请选择<b>空白</b>模板。
...
* <b>在包中创建图形</b>：您可以使用此组合框为新图形创建&#x200B;*新*&#x200B;包，或将新图形添加到资源管理器面板中已加载的任何&#x200B;*现有*&#x200B;包中。\
