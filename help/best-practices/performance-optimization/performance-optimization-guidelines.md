...
这是因为每个节点的输出会尽可能进行缓存。 因此，可补间节点在图形上的位置越靠上，只要修改这些公开参数中的一个，就需要处理更多的输出。 如果公开的图形靠近结尾，则只需重新计算该节点与输出节点之间的少数节点。
...
![嵌入的位图优化1](performance-optimization-guidelines.resources/performance-optimization-guidelines-01.jpg "嵌入的位图优化1")

![嵌入式位图优化2](performance-optimization-guidelines.resources/performance-optimization-guidelines-02.jpg "嵌入式位图优化2")
...
![嵌入的位图优化3](performance-optimization-guidelines.resources/performance-optimization-guidelines-03.jpg "嵌入的位图优化3")
