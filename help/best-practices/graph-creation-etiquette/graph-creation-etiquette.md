...
![Substance图中的帧](graph-creation-etiquette.resources/graph-creation-etiquette-01.gif "Substance图中的帧")
...
![输入和输出放置](graph-creation-etiquette.resources/graph-creation-etiquette-02.gif "输入和输出放置")
...
![链接重路由](graph-creation-etiquette.resources/graph-creation-etiquette-03.gif "链接重路由")
...
![标识符和标签](graph-creation-etiquette.resources/graph-creation-etiquette-04.png "标识符和标签")

尽量不让标识符和标签差异太大：如果标识符在其他地方使用（在多个函数中），则很难找到与哪个变量相关的UI属性。

![标识符清晰度](graph-creation-etiquette.resources/graph-creation-etiquette-05.png "标识符清晰度")

尝试将您的标签与您在帧（帧标签）和注释中使用的术语匹配。 这样可以更轻松地找出图表的哪个部分与显示的参数有关

![匹配的帧和参数标签](graph-creation-etiquette.resources/graph-creation-etiquette-06.png "匹配的帧和参数标签")
...
![颜色和灰度转换](graph-creation-etiquette.resources/graph-creation-etiquette-07.png "颜色和灰度转换")
