...
| **类型** | <b>类型</b>用于定义[Substance图形](../../compositing-graphs/substance-compositing-graphs.md)的预期用途。 它主要用于[“发送”互操作性功能](../../interface/the-explorer-window/send-to-interoperability/send-to-interoperability.md) [。](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/send-to-215286290.html) |
