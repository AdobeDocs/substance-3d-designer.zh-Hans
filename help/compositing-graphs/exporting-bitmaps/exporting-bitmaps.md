...
本页介绍Substance 3D Designer如何导出为多种不同的位图文件格式，以及如何批量导出多个UV磁贴。[如果要导出到PSD文件，](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/exporting-psd-186974407.html) [此项目有一个单独的专用页。](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/exporting-psd-186974407.html)
...
* 已为所有输出/位图设置Filetype。
* 导出不同于[发布](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/publishing-sbsar-file-200574380.html)，请确保您充分理解其中的差异！
...
在[资源管理器窗口](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html)中，右键单击要导出的图形，然后选择&#x200B;**“将输出导出为位图”**
