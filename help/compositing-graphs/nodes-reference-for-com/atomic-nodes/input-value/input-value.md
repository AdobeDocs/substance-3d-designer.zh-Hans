...
![原子节点：输入值](input-value.resources/comp_inputnumeric_1.png "原子节点：输入值"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-value.resources/input-value-tooltip.gif" alt="输入值工具提示" /></div>
...
![图形中的主要输入](input-value.resources/node-primary-input.png){width="20%"}
