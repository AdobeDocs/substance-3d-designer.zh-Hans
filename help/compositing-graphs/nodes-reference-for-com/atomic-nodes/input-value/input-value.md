...
breadcrumb-title: ""
description: 使用“输入值”节点为可由用户公开和调整的Substance图形创建值输入参数。
...
![原子节点：输入值](input-value.resources/comp_inputnumeric_1.png "原子节点：输入值")
...
<div data-preserve-html="true" style="text-align: center;"><img src="input-value.resources/input-value-tooltip.gif" alt="输入值工具提示" /></div>
...
![图形中的主要输入](input-value.resources/node-primary-input.png)
