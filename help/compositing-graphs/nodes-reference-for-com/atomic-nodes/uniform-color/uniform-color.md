...
![原子节点：统一颜色](uniform-color.resources/comp_uniform_1.png "原子节点：统一颜色")
...
<div data-preserve-html="true" style="text-align: center;"><img src="uniform-color.resources/uniform-color-tooltip.gif" alt="统一颜色工具提示" /></div>
