...
![原子节点：输入颜色](input.resources/comp_inputcolor_1.png "原子节点：输入颜色"){width="20%"}

</td>
<td style="border: 0;" valign="top">

![原子节点：输入灰度](input.resources/comp_inputgrayscale_1.png "原子节点：输入灰度"){width="20%"}

</td>
<td style="border: 0;" valign="top">

![原子节点：输入值](input.resources/comp_inputnumeric_1.png "原子节点：输入值"){width="20%"}

</td>
</tr>
</table>

<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input.resources/input-color-tooltip.gif" alt="输入颜色工具提示" /></div>
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input.resources/input-grayscale-tooltip.gif" alt="输入灰度工具提示" /></div>
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input.resources/input-value-tooltip.gif" alt="输入值工具提示" /></div>
...
![图形中的主要输入](input.resources/node-primary-input.png){width="20%"}
...
>[!IMPORTANT]
>
> 在[Substance 3D资源(SBSAR)](../../../publishing-asset-files/publishing-substance-3d-asset-files-sbsar.md)中，输入节点的&#x200B;*相对于输入*&#x200B;继承方法&#x200B;*不受支持*。 在发布包之前，将所有输入节点的继承方法设置为&#x200B;*相对于父级*。
