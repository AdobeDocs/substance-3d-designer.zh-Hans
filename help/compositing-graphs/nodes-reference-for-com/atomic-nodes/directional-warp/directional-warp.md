...
breadcrumb-title: ""
description: 使用定向翘曲节点将方向扭曲应用于用于创建流和运动效果的纹理。
...
![原子节点：方向变形](directional-warp.resources/comp_directionalwarp_1.png "原子节点：方向变形"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="directional-warp.resources/directional-warp-tooltip.gif" alt="定向变形工具提示" /></div>
...
| <b>变形角度</b> *Float* | 设置变形效果的角度（以转角数为单位）。 |
| <b>输入筛选模式</b> *布尔值* | 控制是否使用最接近或双线性的筛选对<b>输入</b>采样。 |
| <b>强度图偏移</b> *Float* | 此值从<b>强度输入</b>图像值中减去。 |

## 输入连接器

|  |  |
| --- | --- |
| <b>输入</b> *灰度/颜色*&#x200B;主要 | 应用变形效果的灰度或彩色输入图像。 |
...
![方向变形 — 示例1](directional-warp.resources/dir-warp.gif "方向变形 — 示例1"){width="20%"}{zoomable="yes"}
