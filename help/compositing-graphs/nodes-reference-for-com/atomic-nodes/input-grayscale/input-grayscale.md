...
![原子节点：输入灰度](input-grayscale.resources/comp_inputgrayscale_1.png "原子节点：输入灰度"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-grayscale.resources/input-grayscale-tooltip.gif" alt="输入灰度工具提示" /></div>
...
![图形中的主要输入](input-grayscale.resources/node-primary-input.png){width="20%"}
