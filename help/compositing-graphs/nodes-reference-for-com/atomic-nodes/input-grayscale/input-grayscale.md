...
![原子节点：输入灰度](input-grayscale.resources/comp_inputgrayscale_1.png "原子节点：输入灰度")
...
<div data-preserve-html="true" style="text-align: center;"><img src="input-grayscale.resources/input-grayscale-tooltip.gif" alt="输入灰度工具提示" /></div>
