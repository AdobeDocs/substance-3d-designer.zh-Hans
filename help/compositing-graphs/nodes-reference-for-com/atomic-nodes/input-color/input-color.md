...
breadcrumb-title: ""
description: 使用“输入颜色”节点为可由用户公开和调整的Substance图形创建颜色输入参数。
...
![原子节点：输入颜色](input-color.resources/comp_inputcolor_1.png "原子节点：输入颜色")
...
<div data-preserve-html="true" style="text-align: center;"><img src="input-color.resources/input-color-tooltip.gif" alt="输入颜色工具提示" /></div>
...
![图形中的主要输入](input-color.resources/node-primary-input.png)
...
输入不会直接发送到3D 视图，但[Substance 3D Painter](https://experienceleague.adobe.com/en/docs/substance-3d-painter/using/home)会使用它们的使用情况属性自动为某些映射填充槽（主要与[筛选器](https://experienceleague.adobe.com/en/docs/substance-3d-painter/using/effects/filter)一起使用）。
