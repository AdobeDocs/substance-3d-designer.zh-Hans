...
![原子节点：输入颜色](input-color.resources/comp_inputcolor_1.png "原子节点：输入颜色"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-color.resources/input-color-tooltip.gif" alt="输入颜色工具提示" /></div>
...
![图形中的主要输入](input-color.resources/node-primary-input.png){width="20%"}
