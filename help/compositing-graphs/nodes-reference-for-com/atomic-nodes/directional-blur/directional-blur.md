...
breadcrumb-title: ''
description: 使用定向模糊节点按特定方向应用模糊效果，以创建运动模糊和条纹效果。
...
此节点执行的操作类似于对输入的运动模糊。 与常规“[模糊](../../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/blur/blur.md)”节点（在所有方向上均等模糊）不同，“方向模糊”沿用户定义的角度工作。
