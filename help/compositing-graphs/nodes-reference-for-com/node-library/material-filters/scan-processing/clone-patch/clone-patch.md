...
breadcrumb-title: ''
description: 使用“仿制修补”节点可仿制和修补扫描素材中的区域，以去除伪影和瑕疵。
...
仿制修补是一个程序化的参数化“仿制图章”节点。 它会将输入的一个区域克隆到另一个区域，从而隐藏可能不需要的细节。 虽然这种方法不像使用基于画笔的应用程序中熟悉的工具那样快速和轻松，但它具有非破坏性和在基于节点的工作流程中工作的主要优势。 此外，该节点对目标区域和源区域执行智能分析，并尝试基于对比度、值和形状尽可能好地混合对象。
...
>[!NOTE]
>
> 如果您希望将其用于完整的素材（最常见的情况是），请参阅[素材仿制修补程序](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/material-filters/scan-processing/material-clone-patch/material-clone-patch.md)。
> 
> 如果要同时对多个输入执行此操作（而不使用素材），请参阅[多克隆修补程序](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/material-filters/scan-processing/multi-clone-patch/multi-clone-patch.md)。
