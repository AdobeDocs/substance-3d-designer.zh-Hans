...
![节点图标](../../../../../../assets/paths-vertex-processor-icon.png "节点图标")
...
<b>下一个顶点已访问</b> *整数*\
使用此参数将允许您使用<b>节点</b>参数函数中的<b>Get</b>逐顶点函数，获取以下顶点沿路径(*next.pos*)和以下顶点(*next[2].pos*)的位置。

<b>图像输入计数</b> *整数*\
用于连接应在<b>逐顶点函数</b>参数函数中采样的图像的可见<b>输入#</b>输入连接器的数量。\
