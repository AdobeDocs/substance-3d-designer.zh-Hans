...
![节点图标](paths-vertex-processor-simple.resources/paths-vertex-processor-simple-01.png "节点图标")
...
| <b>逐顶点函数</b> <i>Float2</i> | 应用于每个顶点的函数。 必须返回新顶点位置。<br>有关指导信息，请参阅此页面中的<b>描述</b>部分。 |
...
![节点示例2](paths-vertex-processor-simple.resources/paths-vertex-processor-simple-02.gif "节点示例2")
