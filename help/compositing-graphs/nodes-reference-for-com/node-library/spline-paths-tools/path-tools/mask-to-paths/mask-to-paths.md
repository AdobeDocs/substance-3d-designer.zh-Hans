...
![节点图标](mask-to-paths.resources/mask-to-paths-01.png "节点图标")
...
| <b>角阈值</b> <i>Float</i> | 在路径中编码的每个顶点都可以包含一个标志，指示它是硬（即角）还是平滑。<br>此参数允许您根据相邻段之间的角度标记更多或更少的角。<br><i>注意：</i>此“角”标志当前不受任何现有节点支持，但可在[路径顶点处理器](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/path-tools/paths-vertex-processor/paths-vertex-processor.md)节点中使用。 您也可以使用[预览路径](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/path-tools/preview-paths/preview-paths.md)节点来可视化转角。 |
...
![节点示例2](mask-to-paths.resources/mask-to-paths-06.gif "节点示例2"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![节点示例1](mask-to-paths.resources/mask-to-paths-07.gif "节点示例1"){zoomable="yes"}
...
![节点示例3：启动模式](mask-to-paths.resources/mask-to-paths-08.gif "节点示例3：启动模式"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![节点示例3：排序模式](mask-to-paths.resources/mask-to-paths-09.gif "节点示例3：排序模式"){zoomable="yes"}
