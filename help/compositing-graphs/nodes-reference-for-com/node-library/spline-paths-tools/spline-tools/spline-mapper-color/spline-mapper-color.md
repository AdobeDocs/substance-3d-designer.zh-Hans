...
该节点将映射的图像输出为彩色图像，以及诸如Height、UV（即图像坐标）和用于独立地选择每个映射样条的ID蒙版等其他信息。
...
>[!NOTE]
>
> 另请参阅[样条映射器灰度](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/spline-tools/spline-mapper-grayscale/spline-mapper-grayscale.md)。
...
<b>颜色</b> *颜色*&#x200B;将输入颜色图像映射到输入样条上作为颜色图像的结果。
