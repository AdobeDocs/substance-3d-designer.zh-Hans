...
| <b>结束连接位置</b> <i>浮动</i> | （当“输入样条连接模式”设置为“手动”且“将端点连接到输入样条”设置为“真”时可用）在所选输入样条上所生成样条与端点的连接应处于的位置。<br>此值是所选输入样条的规范化长度。 |
...
| <b>点属性</b> |  |
| <b>p#属性</b> <i>浮点3</i> | 设置p#点的属性。<br>- <i>Height：</i>调整较低值表示较低或较深位置的点的Height；<br>- <i>Smoothness：</i>在p#处偏移样条平滑化的开始，其中值0产生硬轨迹，值1产生完全平滑的轨迹；<br>- <i>Thickness：</i>在p#处调整样条的Thickness。 Thickness由特定的Spline节点使用。 |
| <b>点坐标</b> |  |
