...
* **随机大小映射** *灰度*\
  灰度输入图像，控制形状的随机比例。\
  其影响由&#x200B;**随机大小输入映射乘数**&#x200B;参数控制。
* **随机倾斜映射** *灰度*&#x200B;控制形状的随机倾斜的灰度输入图像。\
  其影响由&#x200B;**随机倾斜输入映射乘数**&#x200B;参数控制。
* **圆角半径映射** *灰度*\
  灰度输入图像，用于控制形状的圆角半径。\
  其影响由&#x200B;**圆角半径输入映射多项式**&#x200B;控制 参数。
* **斜角距离图** *灰度*\
  灰度输入图像，用于控制形状的斜角。\
  其影响由&#x200B;**斜距输入映射多项式**&#x200B;控制 参数。
* **蒙版图** *灰度*\
  控制形状蒙版的灰度输入图像。\
...
* 形状长宽比 — 变换
  ...
  * **圆角半径** *浮动*&#x200B;调整形状圆角的&#x200B;*半径*。 值&#x200B;**0**&#x200B;表示不应用舍入。\
  ...
  * **随机缩放** *浮动*&#x200B;调整对&#x200B;*每个*&#x200B;形状应用随机缩放的强度。
  * **旋转***浮动*&#x200B;通过沿单元格边框将每个&#x200B;*角*&#x200B;移动到其&#x200B;*邻居*&#x200B;来旋转单元格中的形状。\
    此方法导致对旋转处的形状应用某些&#x200B;*扭曲*&#x200B;和&#x200B;*缩放*。
  * **旋转随机** *浮动*&#x200B;调整对每个形状应用随机旋转量的强度。\
    旋转方法在&#x200B;**旋转**&#x200B;参数中描述。
  * **边角位置随机** *浮动*&#x200B;通过将随机数量&#x200B;*偏移*&#x200B;应用于单元格边框上的每个&#x200B;*边角*&#x200B;来扭曲形状。
* 倾斜
  * **随机倾斜乘数** *浮点*\
    将&#x200B;*全局*&#x200B;调整应用于随机倾斜的强度。
  * **随机倾斜输入映射乘数** *浮点*\
...
* 斜面
  ...
  * **启用每轴斜角控制** *布尔值*\
    当&#x200B;*True*&#x200B;时，可在&#x200B;**X**&#x200B;和&#x200B;**Y**&#x200B;轴&#x200B;*单独*&#x200B;应用和调整斜角。\
    *注意*：此&#x200B;*取消* **圆角**&#x200B;效果。
  * **斜面距离X** *浮动*\
    仅调整&#x200B;**X**&#x200B;轴&#x200B;**&#x200B;上的斜面距离。 此距离取决于&#x200B;**斜面距离模式**&#x200B;参数的值。\
    *注意*：仅当&#x200B;**启用每轴斜角控制**&#x200B;参数设置为&#x200B;*True*&#x200B;时，此参数才可用。
  * **斜角距离Y** *浮动*\
...
* 遮罩
  ...
  * **蒙版随机结束** *浮动*&#x200B;对于给定的&#x200B;**随机种子**，按&#x200B;*特定顺序*&#x200B;从起始形状到结束形状应用伪随机蒙版。 此参数允许您&#x200B;*偏移*&#x200B;结束&#x200B;*形状的索引*。\
  ...
  * **按单元格区域结束蒙版***浮动*&#x200B;调整蒙版形状的&#x200B;*最大*&#x200B;单元格区域阈值。\
    *注意*：这确定了蒙版的&#x200B;*值范围*&#x200B;的一个限制。 因此，该值可能比&#x200B;**按单元格区域蒙版起始**&#x200B;值&#x200B;*低*。
  * **蒙版映射输入反转** *布尔值*\
    通过&#x200B;**蒙版映射**&#x200B;输入映射反转形状的蒙版。
  * **蒙版映射输入开始** *浮动*\
    调整蒙版形状的&#x200B;**蒙版映射**&#x200B;输入映射中的&#x200B;*最小灰度值*&#x200B;阈值。\
