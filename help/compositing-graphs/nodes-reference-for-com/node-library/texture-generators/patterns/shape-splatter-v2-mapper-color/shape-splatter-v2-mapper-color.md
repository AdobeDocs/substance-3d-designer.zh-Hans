---
title: 形状飞溅v2映射器颜色
description: Designer >Substance合成图形>用于Substance合成图形的节点引用>节点库>生成器>图案>形状飞溅v2映射器颜色
...
|                                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|:--------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>输入</b>网格图集 *颜色* | 打包到网格版面中的图案的彩色图像。<br><br>网格大小应与[形状飞溅v2](../shape-splatter-v2/shape-splatter-v2.md)节点使用的网格大小匹配。<br><br>使用[网格图集颜色](../grid-atlas-color/grid-atlas-color.md)节点将单独的图案打包到网格图集中。 |
...
| <b>输入选择模式</b> *整数* | 选择应映射到形状的输入图像的方法。<br><br>在源“形状飞溅v2”节点中选择的<b>形状类型</b>更改了将图像分配给形状的方式：<br><br>-<b>网格图集</b>表示通过匹配的网格索引在“网格图集输入”中获取图像（两个图集应使用相同的网格大小）<br>-<b>模式输入</b>表示通过匹配索引在“模式输入#”输入中获取图像。<br>-<b>其他形状类型：</b>图像是通过将索引与形状的材质ID匹配来分配的。<br><br>可用选择索引的方法包括：<br>- <b>从飞溅数据：</b>将“图案输入#”或“网格图集输入”图像的索引与“形状飞溅v2”节点分配的形状的索引匹配。<br>- <b>手动：</b>使用“图像索引”参数指定的索引。<br>- <b>随机：</b>在“随机范围”参数指定的范围内使用随机索引。 |
...
| <b>HSL随机</b> *浮点3* | 应用于形状的色相、饱和度和明亮度(HSL)的随机正偏移或负偏移，直到指定值。 |
