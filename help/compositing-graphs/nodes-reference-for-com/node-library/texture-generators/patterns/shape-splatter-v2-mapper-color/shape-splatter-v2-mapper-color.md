...
使用节点提供的其他数据，将颜色图像映射到使用[形状飞溅v2](../shape-splatter-v2/shape-splatter-v2.md)节点生成和散布的形状上。<br><br>图像可作为单独的图案输入提供或打包到网格图集中，并可使用UV映射、三面投影或自定义映射应用于形状。<br><br>形状可以着色，并且可以针对每个形状统一或随机调整其颜色。

另请参阅[形状飞溅v2映射器灰度](../shape-splatter-v2-mapper-grayscale/shape-splatter-v2-mapper-grayscale.md)。
...
|                                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|:--------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>输入</b>网格图集 *颜色* | 打包到网格布局中的图案的彩色图像。<br><br>网格大小应与[形状飞溅v2](../shape-splatter-v2/shape-splatter-v2.md)节点使用的颜色大小匹配。<br><br>使用[网格图集颜色](../grid-atlas-color/grid-atlas-color.md)节点将单独的图案打包到网格图集中。 |
| <b>模式输入1</b> *颜色* | 映射到形状的#1图案的彩色图像。<br><br><i>提示：</i>请使用接近图案在散布时可能具有的最大大小的分辨率。 |
| <b>模式输入2</b> *颜色* | 映射到形状的#2图案的彩色图像。<br><br><i>提示：</i>请使用接近图案在散布时可能具有的最大大小的分辨率。 |
| <b>模式输入3</b> *颜色* | 映射到形状的#3图案的彩色图像。<br><br><i>提示：</i>请使用接近图案在散布时可能具有的最大大小的分辨率。 |
| <b>模式输入4</b> *颜色* | 映射到形状的#4图案的彩色图像。<br><br><i>提示：</i>请使用接近图案在散布时可能具有的最大大小的分辨率。 |
| <b>模式输入5</b> *颜色* | 映射到形状的#5图案的彩色图像。<br><br><i>提示：</i>请使用接近图案在散布时可能具有的最大大小的分辨率。 |
| <b>模式输入6</b> *颜色* | 映射到形状的#6图案的彩色图像。<br><br><i>提示：</i>请使用接近图案在散布时可能具有的最大大小的分辨率。 |
| <b>模式输入7</b> *颜色* | 映射到形状的#7图案的彩色图像。<br><br><i>提示：</i>请使用接近图案在散布时可能具有的最大大小的分辨率。 |
| <b>模式输入8</b> *颜色* | 映射到形状的#8图案的彩色图像。<br><br><i>提示：</i>请使用接近图案在散布时可能具有的最大大小的分辨率。 |
| <b>背景输入</b> *颜色* | 用作映射形状的背景的彩色图像。 |
| <b>颜色输入</b> *颜色* | 用于根据映射形状的中心点位置对映射形状进行着色的彩色图像。<br><br>使用<b>颜色输入不透明度</b>参数调整这些颜色对形状颜色的贡献强度。 |
...
| <b>是正常映射</b> *布尔值* | 指定提供给<b>网格图集输入</b>或<b>图案输入#</b>的图像是法线图。<br><br>这是正确处理法线矢量并将其应用于形状所需的处理所必需的。 |
| <b>输入普通格式</b> *整数* | 提供给<b>网格图集输入</b>或<b>模式输入#</b>的法线图的格式。<br><br>有效地反转绿色通道。<br><br>- <b>DirectX：</b>Y轴指向上。<br>- <b>OpenGL：</b>Y轴指向下。 |
...
| <b>输入选择模式</b> *整数* | 选择应映射到形状的输入图像的方法。<br><br>在源“形状飞溅v2”节点中选择的<b>形状类型</b>更改了将图像分配给形状的方式：<br><br>- <b>网格图集</b>表示通过匹配网格索引在“网格图集输入”中获取图像（两个图集应使用相同的网格大小）<br>- <b>模式输入</b>表示通过匹配索引在“模式输入#”输入中获取图像。<br>- <b>其他形状类型：</b>图像是通过将索引与形状的材料ID进行匹配来分配的s.<br><br>选择索引的可用方法是：<br>- <b>从飞溅数据：</b>将“图案输入#”或“网格图集输入”图像的索引与“形状飞溅v2”节点分配的形状的索引匹配。<br>- <b>手动：</b>使用“图像索引”参数指定的索引。<br>- <b>随机：</b>在“随机范围”参数指定的范围内使用随机索引。 |
