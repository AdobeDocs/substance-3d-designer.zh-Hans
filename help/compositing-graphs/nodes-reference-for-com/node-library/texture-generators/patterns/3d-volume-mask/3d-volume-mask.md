---
helpx_url: "https://helpx.adobe.com/cn/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/patterns/3d-volume-mask.html"
breadcrumb-title: ''
...
| <b>位置UV</b> <i>Float2</i> | 基元在UV空间中的位置。<br><br>*注意*：仅当&#x200B;**位置输入**&#x200B;参数设置为&#x200B;*UV位置*&#x200B;时，此参数才可用。 |
| <b>位置</b> <i>Float3</i> | 基元在世界空间中的位置。<br><br>*注意*：仅当&#x200B;**位置输入**&#x200B;参数设置为&#x200B;*世界空间位置*&#x200B;时，此参数才可用。 |
| <b>旋转</b> <i>Float3</i> | 定义形状在世界空间中的旋转。 |
| <b>羽化宽度</b> <i>Float</i> | 从基元表面向内调整&#x200B;*淡化渐变*&#x200B;的宽度。 |
