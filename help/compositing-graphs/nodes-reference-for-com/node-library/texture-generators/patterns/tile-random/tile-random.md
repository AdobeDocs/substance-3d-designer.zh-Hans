...
* **大小**
  ...
  * **随机Y**： *0.0 - 1.0*&#x200B;在Y轴上随机进行非均匀缩放。
* **间隙**
  * **模式**： *相对于最小砖块，相对于最大砖块*&#x200B;设置砖块大小空隙相对于。
...
* **颜色**
  ...
  * **混合模式**：*添加/子集，最大值/*&#x200B;添加/子集，Alpha混合（颜色）**为背景上的拼贴设置混合模式。
* **蒙版**
