...
| <b>到边缘Thickness的距离</b> *Float* *在“Color Output”参数设置为“Distance to Edge”时可用。* | 设置距离渐变的Thickness。 较低的值会生成&#x200B;*更短的*&#x200B;渐变。 |
| <b>线条颜色</b> *Float/Float4* *在“Color Output”参数设置为“细线”时可用。* | 段的明亮度。   注意：当<b>颜色源不透明度</b>值设置为1时，此参数没有影响。 |
| <b>背景颜色</b> *Float/Float4* *在“Color Output”参数设置为“细线”时可用。* | 段之间可见的背景明亮度。   注意：当<b>混合模式</b>设置为&#x200B;*最大值*&#x200B;时，背景将覆盖其亮度&#x200B;*较亮*&#x200B;的段（如预期的那样）。 |
| <b>随机颜色种子模式</b> *整数* *当“Color Output”参数设置为“每个顶点”、“每个三角形”或“细线”并且“Color Source”参数设置为“随机”时可用。* | 获得用于伪随机色彩分布的种子的方法：<ul data-preserve-html="true"> <li data-preserve-html="true"><b>全局随机植入</b><b>：</b>继承节点图形的植入</li> <li data-preserve-html="true"><b>手动种子</b><b>：</b>使用自定义离散种子</li> </ul> |
| <b>随机颜色种子</b> *整数* *在“Random Color Seed Mode”参数设置为“Manual Seed”并且“Color Source”参数设置为“Random”时可用。* | 在伪随机颜色分布中使用的离散种子值。 |
