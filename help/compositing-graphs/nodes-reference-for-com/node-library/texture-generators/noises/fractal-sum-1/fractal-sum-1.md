---
helpx_url: "https://helpx.adobe.com/cn/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/fractal-sum-1.html"
breadcrumb-title: ''
...
![分形求和1 — 图标](fractal-sum-1.resources/fractal-sum-1-01.png "分形求和1 — 图标"){width="200px"}
...
![分形求和1 — 示例1](fractal-sum-1.resources/fractal-sum-1-02.png "分形求和1 — 示例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![分形求和1 — 示例2](fractal-sum-1.resources/fractal-sum-1-03.gif "分形求和1 — 示例2"){zoomable="yes"}
