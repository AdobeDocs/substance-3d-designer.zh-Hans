...
![分形求和2 — 图标](fractal-sum-2.resources/fractal-sum-2-01.png "分形求和2 — 图标"){width="200px"}
...
![分形求和2 — 示例1](fractal-sum-2.resources/fractal-sum-2-02.png "分形求和2 — 示例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![分形求和2 — 示例2](fractal-sum-2.resources/fractal-sum-2-03.gif "分形求和2 — 示例2"){zoomable="yes"}
