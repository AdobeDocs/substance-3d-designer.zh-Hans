---
helpx_url: "https://helpx.adobe.com/cn/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/moisture-noise.html"
breadcrumb-title: ''
description: 使用水分噪声节点生成水分和凝结图案，以创建湿表面效果。
...
![湿度噪声1 — 图标](moisture-noise.resources/moisture_noise_1.png "湿度噪声1 — 图标"){width="200px"}
...
另请参阅： [水分噪声2](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/texture-generators/noises/moisture-noise-2/moisture-noise-2.md)
...
![水汽噪声1 — 示例1](moisture-noise.resources/moisture_noise_1_1.png "水汽噪声1 — 示例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![水汽噪声1 — 示例2](moisture-noise.resources/noise_moisture_noise_1_v2_speed0.6_aniso0.gif "水汽噪声1 — 示例2"){zoomable="yes"}
...
![水汽噪声1 — 示例3](moisture-noise.resources/noise_moisture_noise_1_v2_speed0.6_aniso1.gif "水汽噪声1 — 示例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![水汽噪声1 — 示例4](moisture-noise.resources/noise_moisture_noise_1_v2_speed0.3_aniso0.6.gif "水汽噪声1 — 示例4"){zoomable="yes"}
