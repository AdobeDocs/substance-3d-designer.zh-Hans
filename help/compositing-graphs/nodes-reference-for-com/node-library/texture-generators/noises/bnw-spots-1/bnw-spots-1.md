---
helpx_url: "https://helpx.adobe.com/cn/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/bnw-spots-1.html"
breadcrumb-title: ''
...
![BnW斑点1 — 图标](bnw-spots-1.resources/bnw-spots-1-01.png "BnW斑点1 — 图标"){width="200px"}
...
![BnW斑点1 — 示例1](bnw-spots-1.resources/bnw-spots-1-02.png "BnW斑点1 — 示例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![BnW斑点1 — 示例2](bnw-spots-1.resources/bnw-spots-1-03.gif "BnW斑点1 — 示例2"){zoomable="yes"}
...
![BnW斑点1 — 示例3](bnw-spots-1.resources/bnw-spots-1-04.gif "BnW斑点1 — 示例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![BnW斑点1 — 示例4](bnw-spots-1.resources/bnw-spots-1-05.gif "BnW斑点1 — 示例4"){zoomable="yes"}
