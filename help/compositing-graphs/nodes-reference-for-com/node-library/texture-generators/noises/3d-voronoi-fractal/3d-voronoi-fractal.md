...
**3D Voronoi Fractal**&#x200B;节点基于&#x200B;**位置映射**&#x200B;输入在3D空间中生成&#x200B;*分形* Voronoi噪声。
...
* **大小** *Float3*\
  在&#x200B;**X**、**Y**&#x200B;和&#x200B;**Z**&#x200B;轴中控制分形3D Voronoi噪声的大小。 值不一致会产生&#x200B;*拉伸或挤压*&#x200B;效果。\
  *注意*：在&#x200B;*任何轴*&#x200B;上启用&#x200B;**拼贴**&#x200B;时，大小调整为&#x200B;*已分步*。 这是预期的。
* **偏移** *Float3*\
  将偏移应用于&#x200B;**X**、**Y**&#x200B;和&#x200B;**Z**&#x200B;轴的分形3D Voronoi噪声的&#x200B;*位置*。
* **无序** *Float3*\
  应用于&#x200B;**X**、**Y**&#x200B;和&#x200B;**Z**&#x200B;轴中每个噪声点的&#x200B;*随机偏移*&#x200B;的强度。
* **扭曲强度** *Float*\
  控制应用于分形3D Voronoi噪声的&#x200B;*变形效果*&#x200B;的强度。
* **扭曲比例乘数** *Float*\
...
* **混合模式** *整数*\
  设置3D空间中&#x200B;*重叠单元格*&#x200B;的值混合在一起的方法：
  * *添加*：添加值
  * *最大*：保留&#x200B;*最大*&#x200B;值
  * *分钟*：保留&#x200B;*最低*&#x200B;值
* **样式***整数*&#x200B;设置对分形3D Voronoi噪声的数据&#x200B;*进行渲染的方法*，同时考虑噪声基于3D空间中的一组点：
  * *F1*：到3D空间中&#x200B;*最近点*&#x200B;的距离
  * *F2*：到3D空间中&#x200B;*第二个最接近点*&#x200B;的距离
  * *F2-F1*- *F1\* F2 *-* F1/F2 *-*&#x200B;边缘&#x200B;*：3D空间中噪声的每个单元格之间的*&#x200B;边缘*
  * *随机颜色*：为3D空间中的每个噪点单元分配&#x200B;*随机平面颜色*
* **边缘Thickness***Float*&#x200B;调整分形3D Voronoi噪声的细胞之间检测到的边缘Thickness。 在X、Y和Z轴检测边缘，因此某些厚度可能比其他厚度增加得更快，这取决于单元的&#x200B;*深度*。\
  *注意*：仅当&#x200B;**Style**&#x200B;参数设置为&#x200B;*Edge*&#x200B;时，此参数才可用。
* **启用拼贴** *布尔值*\
  调整分形3D Voronoi噪声，使其生成的图案&#x200B;*在X、Y和Z轴中重复*。
