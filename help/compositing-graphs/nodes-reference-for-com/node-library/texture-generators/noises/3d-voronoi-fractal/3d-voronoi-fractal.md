...
* **大小** *浮点3*\
  控制&#x200B;**X**、**Y**&#x200B;和&#x200B;**Z**&#x200B;轴中的分形3D Voronoi噪声的大小。 非均匀值导致&#x200B;*拉伸或挤压*&#x200B;效果。\
  *注意*：在&#x200B;*任意轴*&#x200B;上启用&#x200B;**拼贴**&#x200B;时，大小调整为&#x200B;*步进*。 这是预期的。
* **偏移** *浮点3*\
  将偏移应用于&#x200B;**X**、**Y**&#x200B;和&#x200B;**Z**&#x200B;轴中的分形3D Voronoi噪声的&#x200B;*位置*。
* **无序** *浮动3*\
...
* **混合模式** *整数*\
  ...
  * *最大*：保留&#x200B;*最大*&#x200B;值
  * *分钟*：保留&#x200B;*最低*&#x200B;值
* **样式***整数*&#x200B;设置对分形3D Voronoi噪声的数据渲染&#x200B;*的方法，考虑噪声基于3D空间中的一组点：*
  * *F1*：到3D空间中&#x200B;*最近点*&#x200B;的距离
  * *F2*：到3D空间中&#x200B;*第二个最接近点*&#x200B;的距离
  * *F2-F1*- *F1\* F2 *-* F1/F2 *-*&#x200B;边缘&#x200B;*：3D空间中每个单元之间的*&#x200B;边缘*
  * *随机颜色*：为3D空间中的每个噪点单元分配&#x200B;*随机平面颜色*
* **边缘Thickness***浮点*&#x200B;调整分形3D Voronoi噪声细胞之间检测到的边缘Thickness。 在X、Y和Z轴检测边缘，因此某些厚度可能比其他厚度增加得更快，这取决于单元的&#x200B;*深度*。\
  *注意*：仅当&#x200B;**Style**&#x200B;参数设置为&#x200B;*Edge*&#x200B;时，此参数才可用。
* **启用拼贴** *布尔值*\
  调整分形3D Voronoi噪声，使其生成的图案在X、Y和Z轴上&#x200B;*重复*。
