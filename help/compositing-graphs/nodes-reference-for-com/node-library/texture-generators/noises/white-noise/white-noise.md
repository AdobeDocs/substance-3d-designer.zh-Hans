...
![白噪声 — 图标](white-noise.resources/white-noise-01.png "白噪声 — 图标"){width="200px"}
...
![白噪声 — 示例1](white-noise.resources/white-noise-02.png "白噪声 — 示例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![白噪声 — 示例2](white-noise.resources/white-noise-03.gif "白噪声 — 示例2"){zoomable="yes"}
