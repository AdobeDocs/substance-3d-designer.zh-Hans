...
breadcrumb-title: ''
description: 使用“定向噪声4”节点生成具有四个八度音阶的定向噪声图案，用于创建各向异性纹理。
...
![定向噪声4 — 图标](../../../../../../assets/directional_noise_4.png "定向噪声4 — 图标"){width="200px"}
...
![定向噪声4 — 示例1](../../../../../../assets/directional_noise_4_1.png "定向噪声4 — 示例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![定向噪声4 — 示例2](../../../../../../assets/noise_directional_noise_4_v2_speed0.6_aniso0.gif "定向噪声4 — 示例2"){zoomable="yes"}
...
![定向噪声4 — 示例3](../../../../../../assets/noise_directional_noise_4_v2_speed0.6_aniso1.gif "定向噪声4 — 示例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![定向噪声4 — 示例4](../../../../../../assets/noise_directional_noise_4_v2_speed0.3_aniso0.6.gif "定向噪声4 — 示例4"){zoomable="yes"}
