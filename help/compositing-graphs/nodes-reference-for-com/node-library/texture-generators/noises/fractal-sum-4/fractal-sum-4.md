---
helpx_url: "https://helpx.adobe.com/cn/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/fractal-sum-4.html"
breadcrumb-title: ''
description: 使用分形求和4节点生成具有四个八度音阶的分形噪声，用于创建详细的有机纹理。
...
![分形求和4 — 图标](fractal-sum-4.resources/fractal_sum_4.png "分形求和4 — 图标"){width="200px"}
...
![分形求和4 — 示例1](fractal-sum-4.resources/fractal_sum_4_1.png "分形求和4 — 示例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![分形求和4 — 示例2](fractal-sum-4.resources/noise_fractal_sum_4_v2_speed0.6_aniso0.gif "分形求和4 — 示例2"){zoomable="yes"}
