...
![分形求和4 — 图标](fractal-sum-4.resources/fractal-sum-4-01.png "分形求和4 — 图标"){width="200px"}
...
![分形求和4 — 示例1](fractal-sum-4.resources/fractal-sum-4-02.png "分形求和4 — 示例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![分形求和4 — 示例2](fractal-sum-4.resources/fractal-sum-4-03.gif "分形求和4 — 示例2"){zoomable="yes"}
