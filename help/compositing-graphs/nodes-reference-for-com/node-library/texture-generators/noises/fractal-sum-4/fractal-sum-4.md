...
![分形求和4 — 图标](../../../../../../assets/fractal_sum_4.png "分形求和4 — 图标"){width="200px"}
...
![分形求和4 — 示例1](../../../../../../assets/fractal_sum_4_1.png "分形求和4 — 示例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![分形求和4 — 示例2](../../../../../../assets/noise_fractal_sum_4_v2_speed0.6_aniso0.gif "分形求和4 — 示例2"){zoomable="yes"}
