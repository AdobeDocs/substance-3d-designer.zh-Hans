...
![定向噪声2 — 图标](directional-noise-2.resources/directional-noise-2-01.png "定向噪声2 — 图标"){width="200px"}
...
![定向噪声2 — 示例1](directional-noise-2.resources/directional-noise-2-02.png "定向噪声2 — 示例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![定向噪声2 — 示例2](directional-noise-2.resources/directional-noise-2-03.gif "定向噪声2 — 示例2"){zoomable="yes"}
...
![定向噪声2 — 示例3](directional-noise-2.resources/directional-noise-2-04.gif "定向噪声2 — 示例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![定向噪声2 — 示例4](directional-noise-2.resources/directional-noise-2-05.gif "定向噪声2 — 示例4"){zoomable="yes"}
