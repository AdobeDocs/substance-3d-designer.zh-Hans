...
| <b>杂色</b>浮点 | 将杂色应用于随机从其垂直范围中减去的波形。 |
...
| <b>模式</b>整数 | 放置在波形的每个采样处的图案。 |
| <b>图案变化</b>浮点 | 适用于某些图案的额外调整。 |
| <b>无序</b>浮动 | 置换波形的值。    这可用于为其制作动画。 |
| <b>无序速度</b>浮动 | 调整<b>无序</b>参数应用的位移的距离。    这可用于在制作波形动画时控制位移速度。 |
