...
![量化颜色图标](view-color-palette.resources/ViewColorPalette.png "量化颜色图标"){width="200px"}
...
![查看调色板：示例1](view-color-palette.resources/view_color_palette_example_1.png "查看调色板：示例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![查看调色板：示例2](view-color-palette.resources/view_color_palette_example_2.png "查看调色板：示例2"){zoomable="yes"}
...
![查看调色板：示例3](view-color-palette.resources/view_color_palette_example_3.png "查看调色板：示例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![查看调色板：示例4](view-color-palette.resources/view_color_palette_example_4.png "查看调色板：示例4"){zoomable="yes"}
