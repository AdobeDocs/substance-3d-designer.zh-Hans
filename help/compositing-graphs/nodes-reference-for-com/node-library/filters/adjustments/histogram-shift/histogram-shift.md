...
breadcrumb-title: ''
description: 使用“直方图偏移”节点可改变纹理中的直方图分布，从而调整亮度和对比度范围。
...
完全偏移图像的整个范围，在达到范围限制时绕排。

[单击此处观看Substance学院关于直方图偏移的视频。](https://youtu.be/p9wcmJBFyGA?t=492)

## 参数

* **位置**： *0.0 - 1.0*\
  输入移动量。 1.0为完全旋转，等于0.0。
