...
![用于遮盖灰度图标的ID](id-to-mask.resources/id-to-mask-01.png "用于遮盖灰度图标的ID"){width="200px"}
...
![要遮盖的ID：示例2](id-to-mask.resources/id-to-mask-04.gif "要遮盖的ID：示例2"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![要遮盖的ID：示例3](id-to-mask.resources/id-to-mask-05.png "要遮盖的ID：示例3"){zoomable="yes"}
