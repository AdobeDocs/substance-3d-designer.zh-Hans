...
此类别包含用于多种用途的多种节点。 这些节点主要用于单通道输入，并在输出时执行相当高级的效果或修改。
...
最后，还提出了一些有用的高级效果，其中[Flood Fill](../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/effects/flood-fill/flood-fill.md)、[边缘检测](../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/effects/edge-detect/edge-detect.md)和[矢量变形](../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/effects/vector-warp/vector-warp.md)是最佳示例。
