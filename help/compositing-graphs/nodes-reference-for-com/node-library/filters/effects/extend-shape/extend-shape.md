...
| <b>结束位置</b> <i>Float2</i> | <i>扩展矢量</i>的结束位置。 |
| <b>开始明亮度偏移</b> <i>Float</i> | 将明亮度偏移应用于扩展部分<i></i>之前的图像区域。 此明亮度偏移是沿节</i>向节之后的图像区域明亮度插入的<i>。<br><br><i>注意</i>：此参数仅在节点的<b>灰度</b>版本中可用。 |
| <b>结束明亮度偏移</b> <i>Float</i> | 将明亮度偏移应用于扩展部分<i>之后</i>的图像区域。 此明亮度偏移是沿节</i>向节前图像区域的明亮度插入的<i>。<br><br><i>注意</i>：此参数仅在节点的<b>灰度</b>版本中可用。 |
