...
一个反向转换节点，尝试将正切空间正常映射转换回Heightmap。 这是较高级的Height；[与Node相同](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/normal-map/normal-to-height/normal-to-height.md)的选项较少，并且使用不同的计算。
