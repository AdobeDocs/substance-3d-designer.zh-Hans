...
根据已烘焙贴图和用户设置生成黑白色蒙版。 类似于[Painter](https://experienceleague.adobe.com/en/docs/substance-3d-painter/using/home)中的[智能蒙版](https://experienceleague.adobe.com/en/docs/substance-3d-painter/using/features/smart-materials-and-masks)。
