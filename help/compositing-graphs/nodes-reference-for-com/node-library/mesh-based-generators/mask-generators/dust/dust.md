...
breadcrumb-title: ''
description: 使用Dust节点根据Dust几何形状生成网格累积蒙版，用于创建逼真的Dust和颗粒效果。
...
此蒙版表示在遮蔽的降低区域中以及仅在向上脸部的区域中积累的Dust。 需要适当的烘焙AO和世界空间法线才能工作。
...
| <b>世界空间法线</b> <i>颜色输入</i> | 用于Dust放置的已烘焙贴图。 必填！ |
| <b>杂色</b> <i>灰度输入</i> | 自定义Dust映射（可选），仅在“覆盖噪声”设置为True时出现。 |
