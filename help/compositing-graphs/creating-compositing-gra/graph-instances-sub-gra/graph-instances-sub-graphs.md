...
![（刻度）](../../../assets/check.svg)是，对于&#x200B;**Substance 3D文件(SBS)**&#x200B;中加载的图形实例&#x200B;*仅*。 这些实例节点具有&#x200B;*深红色*&#x200B;标签。\
...
![（减号）](../../../assets/forbidden.svg) *不能*&#x200B;检查从&#x200B;**Substance 3D资源(SBSAR)**&#x200B;实例加载的图形，因为这些图形已编译。 您只能在&#x200B;**资源管理器**&#x200B;面板中加载资源以检查显示的图形列表及其参数。 这些实例节点具有&#x200B;*绿色*&#x200B;标签。\
